...
const blindsData = {
  photo: '/blinds/blinds4.webp',
  text: 'All Ambient Blinds up to 12m² are covered by a 5-year parts and materials warranty.'
}

const FeatureComponents: { [key: string]: () => JSX.Element } = {
  'Frame Colours': () =>  <FrameColours />,
  Fabrics: () => <Fabrics />,
  Warranty: () => <Warranty photo={blindsData.photo} text={blindsData.text}/>,
  Privacy: () => <Privacy />,
  Weather: () => <Weather />,
