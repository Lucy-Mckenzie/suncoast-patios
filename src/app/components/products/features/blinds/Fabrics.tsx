...
export default function Fabrics() {
  return (
    ...
    <table className='w-full table-auto border-collapse border border-base-300 bg-base'>
      <thead>
      ...
      <tbody>
        <tr className='text-sm text-content'>
          ...
          <td className='border border-base-300'>
            ...
            width={150}
            height={150}
            className='object-cover block w-24 h-13'
            />
          </td>
        ...
        <tr className='text-sm text-content'>
          <td className=' px-4 py-2'><strong>1%</strong> - <strong>99%</strong> UV Blockout</td>
        ...
        <tr className='text-sm text-content'>
          <td className='border-b border-base-300 px-4 py-2'></td>
          <td className='border border-base-300 px-4 py-2'>Cocoa-Bean</td>
          <td className='border border-base-300'>
            <Image
        ...
        <tr className='text-sm text-content'>
          <td className='px-4 py-2'><strong>5%</strong> - <strong>95%</strong> UV Blockout</td>
          <td className='border border-base-300 px-4 py-2'>Gull Grey</td>
          <td className='border border-base-300'>
            <Image
