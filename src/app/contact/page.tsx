    ...
    <div className='max-w-5xl mx-auto mt-12 sm:mt-16'>
        <div className='grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3'>
            <div className='overflow-hidden bg-base-100 rounded-xl'>
                <div className='p-6'>
                    ...
                    <p className='mt-6 text-md font-medium text-base'>+64 22 170 9933</p>
                </div>
            </div>
            ...
            <div className='overflow-hidden bg-base-100 rounded-xl'>
                <div className='p-6'>
                    ...
                    <p className='mt-6 text-md font-medium text-base'>info@suncoastpatios.co.nz</p>
                </div>
            </div>
        ...
        <div className='mt-6 overflow-hidden bg-base-100 rounded-xl'>
            <div className='px-6 py-12 sm:p-12'>
                <h3 className='text-3xl font-semibold text-center text-gray-900 pb-4'>Send us a message</h3>
                <Form />
            </div>
        </div>
    </div>
